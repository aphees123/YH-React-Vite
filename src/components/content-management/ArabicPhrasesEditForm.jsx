...
const ArabicPhrasesEditForm = () => {
    ...
    useEffect(() => {
        if (initialData) {
            setFormData({
                ...
                arabicText: initialData.arabicPhrase || '',
                pronunciation: initialData.pronunciation || '',
                category: initialData.category || '',
                englishText: initialData.phrase || '',
                categoryIcon: initialData.categoryIcon || '',
            });
        } else {
            navigate('/content-management/arabic-phrases');
        }
    }, [initialData, phraseId, navigate]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/arabic-phrases/phrases/${phraseId}`, {
                method: 'PUT',
            ...
            if (!response.ok) {
                ...
                throw new Error(message || 'Failed to update Arabic phrase');
            }

            setToast({ show: true, message: 'Arabic phrase updated successfully!', type: 'success' });
...
export default ArabicPhrasesEditForm;
